...
const Automobiles = () => {
    ...
    let imageSource = "https://rukminim1.flixcart.com/fk-p-flap/128/128/image/05d708653beff580.png?q=100";
    return (
        <>
            <ItemCarousel items={items} itemname={"Automobile"} imageSource={imageSource}/>   
        </>
    )
}
